 ...
 if (message.guild == null) return
    ...
    if (!message.member.hasPermission("ADMINISTRATOR")) {
      const yetkinyokmeh = new discord.MessageEmbed()
        .setAuthor("<a:axze_iptal:929762366692929616> Yetersiz Yetki!")
    ...
    if (!islem) {
      const islemyok = new discord.MessageEmbed()
        .setAuthor("<a:axze_iptal:929762366692929616> Argüman Eksik!")
    ...
    if (!islemlerarr.includes(islem.toLowerCase())) {
      const yanlisislem = new discord.MessageEmbed()
        .setAuthor("<a:axze_iptal:929762366692929616> Yanlış Argüman!")
    ...
    if (islem.toLowerCase() == "başlat") {
      ...
      if (kanalget == null) {
        const kanalyok = new discord.MessageEmbed()
          .setAuthor("<a:axze_iptal:929762366692929616> Toplantı Kanalı Belirtilmemiş!")
          .setColor("RED")
      ...
      if (stafflar == null) {
        const embedstafflaryok = new discord.MessageEmbed()
          .setAuthor("<a:axze_iptal:929762366692929616> Stafflar Belirtilmemiş!")
      ...
      try {
        ...
        const sucembed = new discord.MessageEmbed()
          .setAuthor("<a:axze_onay:929763543618830416> Başarılı!")
        ...
        const yetkimyok = new discord.MessageEmbed()
          .setAuthor("<a:axze_iptal:929762366692929616> Yetkim Yetersiz!")
      ...
      if(durumfetch == null) {
        ...
        .setAuthor("<a:axze_iptal:929762366692929616> Önce Toplantıyı Başlatmalısın!")
        .setColor("RED")
